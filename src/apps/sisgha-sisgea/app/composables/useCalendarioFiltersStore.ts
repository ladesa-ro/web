...
export const useCalendarioFiltersStore = defineStore('calendario-filters', () => {
  ...
  return {
    anoLetivo, formacaoId, calendarioId, campusId, searchQuery,
    gestaoCalendariosStatus,
    gestaoEventosStatus, gestaoEventosTipo, gestaoEventosParticipantes,
    gestaoEventosPeriodoInicio, gestaoEventosPeriodoFim, gestaoEventosCalendarioId,
    resetAll, resetGestaoEventos, resetGestaoCalendarios,
  };
});
