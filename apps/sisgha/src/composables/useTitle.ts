...
export const buildTitle = (title: MaybeArray<string | null>, context: HeadTitleContext | null = null): string => {
  const elements = [];
...
export const useTitle = (context: HeadTitleContext | null = null, title: string | null = null) => {
