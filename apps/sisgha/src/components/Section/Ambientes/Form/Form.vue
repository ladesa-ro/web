...
const handleDelete = async () => {
  ...
  const resposta = window.confirm("Você tem certeza de que deseja deletar esse ambiente?");
...
<template>
  <v-form @submit.prevent="onSubmit" class="form">
    ...
    <div class="form-body modal-form">
      ...
      <VVTextField v-model="descricao" type="text" label="Descrição" placeholder="Digite aqui" name="descricao" />

      <VVTextField v-model="codigo" type="text" label="Código" placeholder="Digite aqui" name="codigo" />

      <VVTextField v-model="capacidade" type="number" label="Capacidade" placeholder="Digite aqui" name="capacidade" />

      <VVTextField v-model="tipo" type="text" label="Tipo" placeholder="Digite aqui" name="tipo" />
    </div>
