...
import { turmasBaseQueryKey, useApiBaseResourceList, useTurmasRetriever } from "~/integrations";
...
const { previousItems: turmas } = await useApiBaseResourceList(turmasBaseQueryKey, turmasRetriever, options);
