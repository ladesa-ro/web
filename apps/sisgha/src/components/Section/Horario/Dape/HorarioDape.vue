...
<template>
  <v-expansion-panels multiple v-model="activeCalendar" class="calendario-expansion-panels gap-3 px-8 py-8">
    <v-expansion-panel
    ...
    >
      <v-expansion-panel-title class="!bg-[#118D3B] !rounded-none" :hide-actions="true">
        <div>
      ...
      <v-expansion-panel-title :hide-actions="true" class="text-[#118D3B] flex justify-center">
        <IconsArrowIconArrow
          :class="{
...
.grade-horario {
  ...
  column-gap: 1rem;
  grid-template-columns: max-content max-content repeat(6, minmax(11.25rem, 1fr));
}
...
.calendario-expansion-panels.v-expansion-panels:not(.v-expansion-panels--variant-accordion)
  > :is(
