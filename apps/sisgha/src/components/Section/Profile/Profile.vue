...
<template>
  <div class="py-14 px-4">
    <v-container class="container-image pa-0 gap-5">
      <div class="card-profile ml-5 mt-5 md:ml-8 md:mt-8">
        <div class="container-content items-center overflow-hidden gap-5">
          ...
          <div v-else class="flex py-6 bg-[#F0F0F0] h-[118px] w-[118px] rounded-lg items-center justify-center">
        ...
        <IconsIconEdit class="cursor-pointer flex-shrink-0 mt-4 mr-5 self-start" />
      </div>
      <div
    ...
    <v-container class="my-7 pa-0 flex-col lg:flex-row flex items-stretch gap-x-[12px] gap-y-11">
      <Availability />
