...
<template>
	<div class="flex flex-col items-center gap-12 max-w-screen-2xl mx-auto pb-14">
		...
		<SectionHorarioDailyViewDaysAndLessons v-else-if="selectedOption === ViewMode.DAILY_SCHEDULE" />
	</div>
</template>