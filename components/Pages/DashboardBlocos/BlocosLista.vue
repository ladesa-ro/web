...
<template v-slot:search="{ value }">
  ...
  <!-- <v-container class="">
    <v-row v-if="blocos">
      <v-col cols="12" sm="6" md="4" lg="4" class="px-2" v-for="bloco in blocos" :key="curso.id">
        <v-card class="cardCourses mx-auto" max-width="100%">
          <v-img src="https://picsum.photos/487/120" height="120px" width="100%" cover></v-img>
          <div class="textAndButton">
    ...
    <v-alert v-if="cursos.length === 0" color="info" icon="$info" variant="tonal" title="Nenhum curso encontrado"
      text=""></v-alert>
  </v-container> -->
</template>
