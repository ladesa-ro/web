...
const professores = ref(['Danilo Pereira Escudero', 'Albanita', 'Leticia Pivetta']);
const semestres = ref(['2024.1', '2024.2', '2023.1', '2023.2', '2022.1', '2022.2']);
const bimestres = ref(['1º Bimestre', '2º Bimestre', '3º Bimestre', '4º Bimestre']);
const disciplinas = ref(['Matemática', 'Português', 'História', 'Geografia']);
const cursos = ['Técnico em Informática', 'Técnico em Química', 'Técnico em Florestas', ];
      ...
      <div class="w-full">
        ...
        <!-- divisoria -->
         <div class="divisor relative">
          <div class="filters relative w-25 bg-ldsa-bg mx-[1.2rem] my-0 p-[0.4rem] text-[0.6rem] font-bold text-ldsa-grey z-2">Filtros Opcionais</div>
         </div>
